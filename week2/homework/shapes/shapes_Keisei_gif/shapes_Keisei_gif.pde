...
void setup() {
  ...
  PVector[] vertexIndices = {
    new PVector(ilength*goldenratio, 0, tl), new PVector(ilength*goldenratio, 0, -ilength), new PVector(-ilength*goldenratio, 0, -ilength), new PVector(-ilength*goldenratio, 0, ilength), // X 
